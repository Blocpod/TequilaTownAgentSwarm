...
def _bootstrap() -> None:
    ...
    if not _bin_path.exists():
        ...
        try:
            ...
            print("Warning: Could not download TequilaTown AgentSwarm TUI. The terminal UI will use the default.\n")
# ─────────────────────────────────────────────────────────────────────────────
...
def main() -> None:
    ...
    while True:
        ...
        print("\nStarting TequilaTown AgentSwarm… this may take a few seconds.")
