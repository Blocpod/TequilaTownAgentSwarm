...
This repo powers TequilaTown AgentSwarm. Keep the Agency Swarm mechanics, shared tools, and file-generation agents intact unless a TequilaTown requirement truly needs a change.
...
- Keep only the canonical TequilaTown logo under `assets/tequilatown/logo.png` unless the user explicitly asks to add more assets.
