...
def create_sponsor_intelligence_agent() -> Agent:
    return Agent(
        name="Sponsor Intelligence",
        description="Sponsor reporting, partner engagement, activation ROI, and recap insight specialist.",
        ...
        conversation_starters=[
            "Create a sponsor recap outline.",
            "Rank sponsors by activation engagement.",
            "Identify underperforming sponsor touchpoints.",
        ],
    )
