...
def create_docs_agent() -> Agent:
    return Agent(
        name="Docs Agent",
        description="TequilaTown document engineer for SOPs, sponsor recaps, briefs, plans, PDFs, Markdown, TXT, and DOCX.",
        ...
        conversation_starters=[
            "Draft a TequilaTown sponsor recap and export as PDF.",
            "Create an internal ops SOP and export as DOCX.",
            "Write a weekend activation brief in Markdown.",
            "Create a guest support playbook for concierge staff.",
        ],
    )
